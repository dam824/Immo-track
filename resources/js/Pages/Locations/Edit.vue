...
const form = useForm({
    ...
    loyer_mensuel: props.listing.loyer_mensuel ?? '',
    charges_incluses: props.listing.charges_incluses ?? false,
    charges_locatives: props.listing.charges_locatives ?? '',
...
function submit() {
    form.put(`/locations/${props.listing.id}`);
}
</script>
...
<template>
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            ...
            <h1 class="text-2xl font-bold" style="color: var(--text)">Modifier la location</h1>
        </div>
