...
<template>
    <div class="max-w-2xl">
        <div class="flex items-center gap-3 mb-6">
            <Link href="/achats" class="text-sm transition-colors" style="color: var(--text-4)">← Retour</Link>
            <h1 class="text-2xl font-bold" style="color: var(--text)">Nouvelle annonce achat</h1>
        </div>
        ...
        <form @submit.prevent="submit" class="space-y-4">
            ...
            <div class="rounded-lg p-4 space-y-3" style="background: var(--bg-2); border: 1px solid var(--border-strong)">
                ...
                <div class="grid grid-cols-2 gap-3">
                    ...
                    <div>
                        <label class="text-xs block mb-1" style="color: var(--text-4)">Statut</label>
                        <select v-model="form.statut" class="w-full rounded px-3 py-2 text-sm focus:outline-none" style="background: var(--bg-3); color: var(--text); border: 1px solid var(--border-strong)">
            ...
            <div class="flex gap-3">
                ...
                <Link href="/achats" class="px-6 py-2 rounded text-sm transition-colors" style="background: var(--bg-3); color: var(--text-3)">Annuler</Link>
            </div>
        </form>
    </div>
</template>
