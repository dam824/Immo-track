...
<template>
    <div class="flex min-h-screen" style="background: var(--bg-0); color: var(--text)">
        ...
        >
            ...
            <!-- Bottom: Système -->
            <div class="px-4 py-3 flex-shrink-0" style="border-top: 1px solid var(--border-strong)">
                <div class="text-[10px] font-semibold uppercase tracking-widest mb-2" style="color: var(--text-4)">Système</div>
